...
func (m *defaultTokensModel) Insert(ctx context.Context, data *Tokens) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.ClientId, data.AccessToken, data.RefreshToken, data.ExpiredAt, data.CreatedAt, data.UpdatedAt)
	}, tokensClientIdKey, tokensIdKey)
	return ret, err
}
...
func (m *defaultTokensModel) Update(ctx context.Context, newData *Tokens) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.ClientId, newData.AccessToken, newData.RefreshToken, newData.ExpiredAt, newData.UpdatedAt, newData.Id)
	}, tokensClientIdKey, tokensIdKey)
	return err
}
